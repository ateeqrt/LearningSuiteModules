({
	...
	cxmnotvalid: '<h5 style="text-align: -webkit-center;    margin-top: 6%;">',
    _defaultSettings: {
        limit: 5,
    ...
    person_view_fn: function (evt, view) {
    ...
    setData: function (tab, callback, id) {
        this.social_status = '';
        var that = this;
        that.p1 = false;
        that.loc = false;
    ...
    _appd: function (parsed, im, imflag) {
        var that = this;
        var data = '';
        var pdone = false;
